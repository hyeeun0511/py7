...
#1
# num1 = input("국어점수를 입력하세요.")
# num2 = input("영어점수를 입력하세요.")
# num3 = input("수학점수를 입력하세요.")
# print("합계 : %d" % (int(num1)+int(num2)+int(num3)),"점")
# print("평균 : %.2f" % ( (int(num1)+int(num2)+int(num3))/3),"점")
...
# print("합계 :",num1+num2+num3,"점")
# print("평균 :",(num1+num2+num3)/3,"점")
# print("평균 :","%.2f" % ((num1+num2+num3)/3),"점")
...
print("%s\t%d\t%d\t%d\t%d\t%.2f\t" % (name2,kor2,eng2,math2,(kor2+eng2+math2),(kor2+eng2+math2)/3))   # f 실수_소수점으로
